...
<head>
  ...
  <title>Карта объектов АО "ДРСК" — <?=$current_menu['text'] ?></title>
  ...
  <link rel="icon" type="image/png" href="/drsk_logo_favicon.png" />
  <!-- <link rel="stylesheet" href="http://yandex.st/jquery-ui/1.9.0/themes/base/jquery-ui.min.css" /> -->
  <link rel="stylesheet" href="js/jquery-ui/1.9.0/themes/base/jquery-ui.min.css" />
  <? print($page_head_css); ?>
  ...
  <script src="js/jquery-ui/1.9.0/jquery-ui.min.js"></script>
