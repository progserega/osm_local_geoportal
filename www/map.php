    ...
    -->
      ...
      <div id="search_container">
        <form role="search" id="search" method="get" action="/" onsubmit="return osm.ui.searchsubmit();">
          <div id="fucking_ff">
            <input type="search" id="qsearch" class="field" name="q" autocomplete="off" autofocus="" placeholder="Адрес или наименование подстанции/ТП, кадастровый номер...">
          </div>
...
$page_content = <<<PHP_CONTENT
  <aside id="leftpan">
    <div id="leftpantab">
      <div id="leftpoi" class="leftgroup">
        <h1>Детальная информация по объектам на карте<img class="loader" src="/img/loader.gif" alt=""></h1>
      ...
      <div id="leftsearch" class="leftgroup" style="display: none;">
        ...
        <div class="leftcontent" style="display: none;">
          <div class="drsksearch"></div>
          <div class="coordsearch"></div>
          <div class="kadastrsearch"></div>
          <div class="kadastrpkksearch"></div>
      ...
      <div id="leftothersmaps" class="leftgroup leftlink">
        ...
        <div class="leftcontent" style="display: none;">
          <ul>
            <li><a id="opento-windyty" href='#' target="_blank">Прогноз погоды Windyty</a></li>
            <li><a id="opento-kadastre" href='#' target="_blank">Кадастр</a></li>
            <li><a id="opento-yandex" href='#' target="_blank">Яндекс карты</a></li>
            <li><a id="opento-google" href='#' target="_blank">Google карты</a></li>
            <li><a id="opento-osmdrsk" href='#' target="_blank">osm.prim.drsk.ru (объекты ДРСК)</a></li>
  ...
  <section id="mappan">
    ...
    <article id="pers_maps">
      ...
      <div id="note_edit_popup" style="display: none;">
        <table id="new_note_popup">
          <tr><td><input id="new_note_user_name" type="text" value="Ваше Ф.И.О." class="default-input" onFocus="osm.markers.focusDefaultInput(this)" onBlur="osm.markers.blurDefaultInput(this)"/></td></tr>
          <tr><td><textarea id="new_note_description" class="default-input" onFocus="osm.markers.focusDefaultInput(this)" onBlur="osm.markers.blurDefaultInput(this)" >Описание неточности на карте...</textarea></td></tr>
          <tr><td><a href="#" class="button" onClick="saveNewNote();return false">Отправить замечание</a>
          </td></tr>
        </table>
      </div>
